  ...
  <div class="mini-carousel-viewport">
    <div class="mini-carousel-track">
      <div class="mini-carousel-slide">
        <img class="lightbox-trigger" src="/images/photoprojects/metis/CONTESTO 1.png" alt="Context render" />
      </div>
      <div class="mini-carousel-slide">
        <img class="lightbox-trigger" src="/images/photoprojects/metis/CONTESTO 3.png" alt="Footrest configuration" />
      </div>
    </div>
  </div>
</div>
...
<div class="split-section-media">
  <div class="mini-carousel-viewport">
    <div class="mini-carousel-track">
      <div class="mini-carousel-slide">
        <img class="lightbox-trigger no-outline" src="/images/photoprojects/metis/cover.png" alt="Base structure reference" />
      </div>
    </div>
  </div>
</div>
...
<div class="split-section-media">
  <div class="mini-carousel-viewport">
    <div class="mini-carousel-track">
      <div class="mini-carousel-slide">
        <img class="lightbox-trigger" src="/images/photoprojects/metis/COLORI1.png" alt="Colour and material renders" />
      </div>
    </div>
  </div>
</div>
